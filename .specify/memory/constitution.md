...
Modified Principles : II. 技术栈约束 — 补充 Minimal API 条目
Added Sections  : Principle VII（RESTful API — .NET Minimal API 优先）
Removed Sections: N/A
Templates Updated:
  ✅ .specify/memory/constitution.md — updated (this file)
  ✅ .specify/templates/plan-template.md — Constitution Check 新增第 VII 条检查项
  ⚠ .specify/templates/spec-template.md — API 设计需求注释待按需更新
  ⚠ .specify/templates/tasks-template.md — API 端点任务分类待按需扩展
Deferred TODOs  : none
-->
